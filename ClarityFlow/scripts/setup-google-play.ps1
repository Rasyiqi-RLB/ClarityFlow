...
Write-Host "📝 Google Play Console Setup Checklist:`n" -ForegroundColor Cyan
...
Write-Host "   □ Package name: com.clarityflow.app`n" -ForegroundColor Gray
...
Write-Host "   □ Add privacy policy URL: https://clarityflow.app/privacy-policy`n" -ForegroundColor Gray
...
Write-Host "   □ Configure gradle.properties with keystore details`n" -ForegroundColor Gray
...
Write-Host "   □ Complete all required fields`n" -ForegroundColor Gray
...
Write-Host "   □ Submit for rating`n" -ForegroundColor Gray
...
Write-Host "   □ Review and rollout`n" -ForegroundColor Gray
